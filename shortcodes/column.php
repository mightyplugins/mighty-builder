...
if (class_exists('MB_Element')) {
	...
	$column_map = array(
		...
		'options' => array(
			...
			array(
				'id' => 'class',
				'label'    => __( 'Column Extra Class', 'mytheme' ),
				'type'     => 'text',
				'default' => '',
                'tab' => 'Settings'
			),
			array(
				'id' => 'col',
				'label'    => __( 'Column Size', 'mytheme' ),
				'subtitle'    => __( 'Note: This value is readonly. You can\'t change it from here.', 'mytheme' ),
				'type'     => 'readonly',
				'tab' => 'Settings'
			),
			array(
