<div class="mb-input-field mb-input-field-editor">
    <div id="wp-{{ data.id }}-wrap" class="wp-core-ui wp-editor-wrap tmce-active">
        <div id="wp-{{ data.id }}-editor-tools" class="wp-editor-tools hide-if-no-js">
            ...
            <div class="wp-editor-tabs">
                <button type="button" id="{{ data.id }}-tmce" class="wp-switch-editor switch-tmce" data-wp-editor-id="{{ data.id }}"><?php esc_html_e('Visual', 'mighty-builder'); ?></button>
                <button type="button" id="{{ data.id }}-html" class="wp-switch-editor switch-html" data-wp-editor-id="{{ data.id }}"><?php esc_html_e('Text', 'mighty-builder'); ?></button>
            </div>
        </div>
